...
public class TextBubbleBorder extends AbstractBorder {
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
		...
		RoundRectangle2D.Double bubble = new RoundRectangle2D.Double(0 + strokePad, 0 + strokePad, width - thickness, bottomLineY, radii,
				radii);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				l.setOpaque(true);
				l.setBorder(new TextBubbleBorder(Color.gray.darker(), 2,10,  0));
				l.setOpaque(true);
