...
public class TermsAndConditionsPatient extends JFrame
    ...
    public TermsAndConditionsPatient(String usertype,final PatientRegisterBO bo, final JFrame parent, final JFrame thisParent) {
			        ...
			        if(entree.equalsIgnoreCase("Agree")){
			        	...
			        	SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>(){
							...
							protected Void doInBackground() throws Exception {
								...
								PatientRegistrationJSON physicianJSON = new PatientRegistrationJSON(bo);
								String returnMessage = physicianJSON
								...
								if (jsonResponse.getString("err-code").equals("700")) {
									...
									Login.doLogin(bo.getUsername(), bo.getPassword());
...
//									 	XmppUtils.doLogin(username_xmpp, password_xmpp, null);
									...
									.showMessageDialog(getRootPane(),
											"Practice Type or Job Title or Designation Not Found. ");
       ...
       // getContentPane().add(buttonPanel, BorderLayout.NORTH);
        ...
        getContentPane().add(TopPanel.topButtonPanelForTermsDialog(this, labeltitle.getText(),thisParent),BorderLayout.NORTH);
//        getContentPane().add(labeltitle);
        getContentPane().add(new LightScrollPane(displayEditorPane),
                BorderLayout.CENTER);
