...
public class TermsAndConditionsStaff extends JFrame
    ...
    public TermsAndConditionsStaff(String usertype,final StaffRegisterBO bo, final JFrame parent, final JFrame thisParent) {
			        ...
			        if(entree.equalsIgnoreCase("Agree")){
			        	...
			        	SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>(){
							...
							protected Void doInBackground() throws Exception {
								...
								StaffRegistrationJSON physicianJSON = new StaffRegistrationJSON(bo);
